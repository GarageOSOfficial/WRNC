...
const sections: PreparedContentSection[] = [
  ...
  { title: 'Security and international processing', body: ['[SECURITY AND COUNSEL REVIEW REQUIRED: describe safeguards and cross-border processing accurately without making unsupported guarantees.]'] },
  ...
  { title: 'Changes and contact', body: ['[COUNSEL REVIEW REQUIRED: effective date, update notice process, mailing address, and monitored privacy contact.]'] },
];
